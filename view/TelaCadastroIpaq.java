...
public class TelaCadastroIpaq extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione ", "1", "2", "3", "4", "5", "6", "7", " " }));
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione", "1", "2", "3", "4", "5", "6", "7" }));
        ...
        jComboBoxDCam.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione ", "1", "2", "3", "4", "5", "6", "7", " " }));

        jLabel12.setText("Dias por semana");

        jCheckBox2.setText("Nenhum");
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione ", "1", "2", "3", "4", "5", "6", "7", " " }));

        jLabel16.setText("Dias por semana");

        jCheckBox4.setText("Nenhum");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jTextField1, javax.swing.GroupLayout.PREFERRED_SIZE, 1126, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        IPAQ ipaq = new IPAQ();
        ipaq.setDiasCaminhou(Integer.parseInt(jComboBoxDCam.getActionCommand()));
        ipaq.setAtivModerada(Integer.parseInt(jComboBox3.getActionCommand()));
        ipaq.setAtivVigorosa(Integer.parseInt(jComboBox2.getActionCommand()));
        /**ipaq.setHorasCaminhou(Time.parseTime(jTextField1.getAction()));
        ipaq.setTempoAtivModerada(Time.parseTime(jComboBox4.getActionCommand()));
        ipaq.setTempoAtivVigorosa(Time.parseTime(jFormattedTextField1.getAction()));
        ipaq.setTempoGastoSentado1(Time.parseTime(jFormattedTextField2.getAction()));
        ipaq.setTempoGastoSentadofds(Time.parseTime(jFormattedTextField3.getAction()));
        */
