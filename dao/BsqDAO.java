...
public class BsqDAO {
    ...
    public void adicionarBsq(Bsq bsq) {
        ...
        try {
            ...
            stmt.setInt(35, bsq.getAluno().getMatricula());
            stmt.executeUpdate();
    ...
    public List<Bsq> listarBsq() {
        ...
        try {
            conexao = postgres.getConection();
            stmt = conexao.prepareStatement ("SELECT * FROM BSQ b INNER JOIN Aluno a ON (b.fk_id_aluno = a.id_aluno) INNER JOIN Endereco e ON (b.fk_id_aluno = e.id_endereco) INNER JOIN Curso c ON (b.fk_id_aluno = c.id_curso) INNER JOIN Turma t ON (b.fk_id_aluno = t.id_turma) INNER JOIN ParentescoAluno p ON (b.fk_id_aluno = p.id_Parentesco)");
            rs = stmt.executeQuery();

            while (rs.next()) {
                Bsq bsq;
                bsq = new Bsq(rs.getInt("id_bsq"),rs.getInt("sentir_intediado_ff"),rs.getInt("preocupado_ff_dieta"),rs.getInt("parte_corpo_cqdg")
    ...
    public void updateBsq(Bsq bsq) {
        ...
        try {
            ...
            stmt.setInt(1, bsq.getSentirIntediadoFF());
            stmt.setInt(2, bsq.getPreocupadoDieta());
            stmt.setInt(3, bsq.getParteCorpocqdG());
            stmt.setInt(4, bsq.getMedoFicarG());
            stmt.setInt(5, bsq.getSatisfeitoSentirG());
            stmt.setInt(6, bsq.getMalCorpoChorar());
            stmt.setInt(7, bsq.getCorrerCorpoBalanca());
            stmt.setInt(8, bsq.getHmagrosPreocupacaoFF());
            stmt.setInt(9, bsq.getPreocupacaoPcorpoEspalhar());
            stmt.setInt(10, bsq.getSentirgMenosComida());
            stmt.setInt(11, bsq.getFisicoHmComparar());
            stmt.setInt(12, bsq.getNuBanhoCorpo());
            stmt.setInt(13, bsq.getEvitarRoupaFcorpo());
            stmt.setInt(14, bsq.getCortaPorcoesCorpo());
            stmt.setInt(15, bsq.getComerCaloriasSentirG());
            stmt.setInt(16, bsq.getParticSentirMalF());
            stmt.setInt(17, bsq.getSentirExcessoG());
            stmt.setInt(18, bsq.getVergonhaCorpo());
            stmt.setInt(19, bsq.getPreocupFisicoDieta());
            stmt.setInt(20, bsq.getSentirContenteEstomagoV());
            stmt.setInt(21, bsq.getFisicoFaltaAutocontrole());
            stmt.setInt(22, bsq.getPreocupPessoasVDobras());
            stmt.setInt(23, bsq.getAcharInjustoPessoasM());
            stmt.setInt(24, bsq.getVomitoSentirMagro());
            stmt.setInt(25, bsq.getAcompanhadoPEspaco());
            stmt.setInt(26, bsq.getPreocuparSurgirDobrasCor());
            stmt.setInt(27, bsq.getReflexoRelacaoFisica());
            stmt.setInt(28, bsq.getBeliscaCorpoGordura());
            stmt.setInt(29, bsq.getEvitarSituacoesVerCorp());
            stmt.setInt(30, bsq.getLaxantesSentirMagro());
            stmt.setInt(31, bsq.getConcienteFisicoCompanhiaPess());
            stmt.setInt(32, bsq.getPreocupacaoFisicoExercicio());
            stmt.setInt(33, bsq.getAluno().getMatricula());
