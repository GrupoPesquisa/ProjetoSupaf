...
public class ParqDAO {
    ...
    public void adicionarParq(Parq parq) {
        ...
        try {
            ...
            stmt.setInt(9, parq.getAluno().getMatricula());
            stmt.executeUpdate();
    ...
    public List<Parq> listarParq() {
        ...
        try {
            ...
            while (rs.next()) {
                Parq parq = new Parq(rs.getInt("codigo"),rs.getBoolean("probl_cardiaco"),rs.getBoolean("dores_peito"), rs.getBoolean("desmaio_freq"),rs.getBoolean("pressao_art"),rs.getBoolean("p_osseo_articular"),rs.getBoolean("r_n_praticar"), rs.getBoolean("mais65anos"), 
    ...
    public Parq getParqPeloCodigo(int codigo) {
        ...
        try {
            ...
            if (rs.next()) {
                Parq parq; 
                parq = new Parq(rs.getInt("codigo"),rs.getBoolean("probl_cardiaco"),rs.getBoolean("dores_peito"),
    ...
    public void updateParq(Parq parq) {
        ...
        try {
            ...
            stmt.setInt(8, parq.getAluno().getMatricula());
            stmt.setInt(9, parq.getCodigo());
