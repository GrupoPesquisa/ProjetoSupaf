...
public void adicionarKidscreen52(Kidscreen52 kidscreen52) {
        ...
        try {
            ...
            stmt.setInt(1, kidscreen52.getCodigo());
            stmt.setInt(2, kidscreen52.getAluno().getMatricula());
            stmt.setBoolean(3, kidscreen52.getDoencaCDeficiencia());
            stmt.executeUpdate();
            ...
            stmt.setInt(9, kidscreen52.getAnimoEmocional().getContenteMSer());
            stmt.setInt(10, kidscreen52.getAnimoEmocional().getContenteRoupas());
            stmt.setInt(11, kidscreen52.getAnimoEmocional().getPreocAspecto());
            stmt.setInt(12, kidscreen52.getAnimoEmocional().getInvejaColegas());
            stmt.setInt(13, kidscreen52.getAnimoEmocional().getParteCMudar());
    ...
    public List<Kidscreen52> listarKidscreen52() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                kidscreen52 = new Kidscreen52(rs.getInt("id_kid"), new SaudeATF(rs.getInt("id_saude"),rs.getInt("sua_saude"),rs.getInt("sentido_bef"),rs.getInt("fisicamente_atv"),rs.getInt("fisicamente_atv")),
                    new Sentimentos(rs.getInt("id_sentimentos"),rs.getInt("desfrutado_vida"),rs.getInt("sentido_contente"),rs.getInt("sentido_satisfeito"),rs.getInt("estado_humor"),rs.getInt("sentido_alegre"), rs.getInt("se_divertido")),
                    new TempoLivre(rs.getInt("id_amigos"),rs.getInt("tempo_vc_mesmo"),rs.getInt("fzrTempolivre"),rs.getInt("oportunidadeArLivre"),rs.getInt("tempoAmigos"),rs.getInt("escolhidoTempoLivre")),
                    new SeusAmigos(rs.getInt("id_amigos"),rs.getInt("estar_amigos"),rs.getInt("realizar_tarefas_jovens"),rs.getInt("divertidoAmigos"),rs.getInt("amigosAjudaOutros"),rs.getInt("falarTudoCamigos"),rs.getInt("confiancaAmigos")),
                    new AnimoEmocional(rs.getInt("codigo"),rs.getInt("sensacaoFzrErrado"),rs.getInt("sentidoTriste"),rs.getInt("sentidoMalFzrNada"),rs.getInt("sensacaoVidaMal"),rs.getInt("sentidoCheioVida"),rs.getInt("sentidoSo"),rs.getInt("sentidoPressao"), rs.getInt("ContenteMSer"),rs.getInt("ContenteRoupas"),rs.getInt("PreocAspecto"),rs.getInt("InvejaColegas"), rs.getInt("ParteCMudar")),
                    new AssuntosFinanceiros(rs.getInt("codigo"),rs.getInt("dinheiroSuficiente"),rs.getInt("dinheiroSuficienteGastos"),rs.getInt("dinheiroSuficienteAmigos")),
                    new VidaFamiliar(rs.getInt("codigo"),rs.getInt("entendimentoPais"),rs.getInt("sentqueridoPais"),rs.getInt("felizCasa"),rs.getInt("tempPais"),rs.getInt("tratJustoPais"),rs.getInt("dialogoPais")),
                    new VoceMesmo(rs.getInt("codigo"),rs.getInt("contenteManeira"),rs.getInt("contenteRoupas"),rs.getInt("preocupadoAspcto"),rs.getInt("invejaColegas"),rs.getInt("parteCorpoMudar")),
                    new SuaEscola(rs.getInt("codigo"),rs.getInt("sentindoFelizEscola"),rs.getInt("bemNosEstudos"),rs.getInt("satisfeitoCprofessores"),rs.getInt("prestadoAtencaoAulas"),rs.getInt("gostairEscola"),rs.getInt("relacaoCprofessores")),
                    new VoceEosDemais(rs.getInt("codigo"),rs.getInt("medoRapazesMocas"),rs.getInt("rapazesZombadoVoce"),rs.getInt("rapEmocIntimidandoVoce")), rs.getBoolean("DoencaCDeficiencia"),
    ...
    public void updateKidscreen52(Kidscreen52 kidscreen52) {
        ...
        try {
            conexao = postgres.getConection();
            stmt = conexao.prepareStatement("UPDATE kidscreen_52 SET fk_matricula=?, doencac_deficiencia=? WHERE id_kid=?");
            stmt.setInt(1, kidscreen52.getAluno().getMatricula());
            stmt.setBoolean(2, kidscreen52.getDoencaCDeficiencia());
            stmt.setInt(3, kidscreen52.getCodigo());
            ...
            stmt.setInt(1, kidscreen52.getSentimentos().getDesfrutadoVida());
            ...
            stmt.setInt(7 , kidscreen52.getCodigo());
            ...
            stmt.setInt(1, kidscreen52.getSaudeATF().getSuaSaude());
            ...
            stmt.setInt(5, kidscreen52.getCodigo());
            stmt.executeUpdate();
            ...
            stmt.setInt(1, kidscreen52.getTempoLivre().getTempoVcMesmo());
            ...
            stmt.setInt(6, kidscreen52.getCodigo());
            ...
            stmt.setInt(1, kidscreen52.getSeusAmigos().getEstarAmigos());
            ...
            stmt.setInt(1, kidscreen52.getAnimoEmocional().getSensacaoFzrErrado());
            ...
            stmt.setInt(8, kidscreen52.getCodigo());
            ...
            stmt.setInt(1, kidscreen52.getAssuntosFinanceiros().getDinheiroSuficiente());
            ...
            stmt.setInt(4, kidscreen52.getCodigo());
            ...
            stmt.setInt(1, kidscreen52.getVidaFamiliar().getEntendimentoPais());
            ...
            stmt.setInt(1, kidscreen52.getVoceMesmo().getContenteManeira());
            ...
            stmt.setInt(1, kidscreen52.getSuaEscola().getSentindoFelizEscola());
            ...
            stmt.setInt(1, kidscreen52.getVoceEosDemais().getMedoRapazesMocas());
