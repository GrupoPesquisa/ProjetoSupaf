...
public class Parq {
    ...
    public Parq(int codigo, boolean problCardiaco, boolean doresPeito, boolean desmaioFreq, boolean pressaoArt, boolean probOsseo, boolean RNPraticar, Boolean mais65Anos, Aluno aluno){
        this.codigo = codigo;
