...
public class TempoLivre {
    private int codigo, tempoVcMesmo, fzrTempolivre, oportunidadeArLivre, tempoAmigos, escolhidoTempoLivre ;
   
    public TempoLivre(int codigo, int tempoVcMesmo, int fzrTempolivre, int oportunidadeArLivre, int tempoAmigos, int escolhidoTempoLivre){
        this.codigo = codigo;
